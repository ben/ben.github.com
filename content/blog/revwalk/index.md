...
2. We "push" the HEAD commit onto the walk.
...
3. We "hide" from the walk all commits that are included in a tag.
...
_[Implementing `--graph` is left as an exercise for the reader.]_
